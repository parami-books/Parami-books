...
function renderCatalog(market) {
  ...
  availableBooks.forEach(book => {
    ...
    if (asin && !details.comingSoon) {
      ...
      coverUrl = `images/${details.coverImage}?v=2.4`;
    } else if (book.coverImage) {
      coverUrl = `images/${book.coverImage}?v=2.4`;
    } else {
      coverUrl = `images/${prefix}_cover_${currentLanguage}.png?v=2.4`;
    }
    ...
    card.innerHTML = `
      <div class="book-cover-container" id="carousel-${book.id}">
        <div class="carousel-track" style="transform: translateX(0%);">
          ${firstSlideHtml}
          <div class="carousel-slide">
            <img class="book-cover-img" src="images/${prefix}_page_1.png?v=2.4" alt="Página para colorear 1" onerror="this.src='images/mandalas_page_1.png?v=2.4'">
          </div>
          <div class="carousel-slide">
            <img class="book-cover-img" src="images/${prefix}_page_2.png?v=2.4" alt="Página para colorear 2" onerror="this.src='images/mandalas_page_2.png?v=2.4'">
          </div>
          <div class="carousel-slide">
            <img class="book-cover-img" src="images/${prefix}_page_3.png?v=2.4" alt="Página para colorear 3" onerror="this.src='images/mandalas_page_3.png?v=2.4'">
          </div>
        </div>
