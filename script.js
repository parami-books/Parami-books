...
function renderCatalog(market) {
  ...
  availableBooks.forEach(book => {
    ...
    if (details.coverImage) {
      coverUrl = `images/${details.coverImage}?v=12.0`;
    } else if (book.coverImage) {
      coverUrl = `images/${book.coverImage}?v=12.0`;
    } else if (asin && !details.comingSoon) {
      coverUrl = `https://images-na.ssl-images-amazon.com/images/P/${asin}.01.LZZZZZZZ.jpg`;
    } else {
      coverUrl = `images/${prefix}_cover_${currentLanguage}.png?v=12.0`;
    }
    ...
    if (isAmazonCover) {
      firstSlideHtml = `
        <div class="carousel-slide">
          <img class="book-cover-img" src="${coverUrl}" alt="Portada de ${details.title}" onerror="this.onerror=null; this.src='images/${prefix}_cover_${currentLanguage}.png?v=12.0'">
        </div>
      `;
    } else {
      firstSlideHtml = `
    ...
    card.innerHTML = `
      <div class="book-cover-container" id="carousel-${book.id}">
        <div class="carousel-track" style="transform: translateX(0%);">
          ${firstSlideHtml}
          <div class="carousel-slide">
            <img class="book-cover-img" src="images/${prefix}_page_1.png?v=12.0" alt="Página para colorear 1" onerror="this.src='images/mandalas_page_1.png?v=12.0'">
          </div>
          <div class="carousel-slide">
            <img class="book-cover-img" src="images/${prefix}_page_2.png?v=12.0" alt="Página para colorear 2" onerror="this.src='images/mandalas_page_2.png?v=12.0'">
          </div>
          <div class="carousel-slide">
            <img class="book-cover-img" src="images/${prefix}_page_3.png?v=12.0" alt="Página para colorear 3" onerror="this.src='images/mandalas_page_3.png?v=12.0'">
          </div>
        </div>
